...
namespace Hello_MultiScreen_iPhone
{
    public partial class HomeScreen2 : UIViewController
    {
        ...
        public void ViewDidLoad1()
        {
            ...
            scratchpad.BackgroundColor = HomeScreen.buttoncolor;
        ...
        */
        ...
        public override void ViewDidAppear(bool animated)
        {
            ...
            scratchpad.Frame = new CGRect(ResponsiveWidthRight, 500, 100, 30);
            buttonAdd.Frame = new CGRect(listView.Frame.Right + 20, scratchpad.Frame.Bottom + 30, 50, 30);
            ...
            if (UIKit.UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad || View.Frame.Height >= 1300)
            {
                ...
                listView.Frame = new CGRect(ResponsiveWidthLeft, editTextDate.Frame.Bottom + 30, 250, 150);
                scratchpad.Frame = new CGRect(rightpad, ButtonyourstoryscreenUpload.Frame.Bottom + 30, 100, 30);
                buttonAdd.Frame = new CGRect(listView.Frame.Right + 20, scratchpad.Frame.Bottom + 30, 50, 30);
            ...
            if (View.Frame.Height >= 850 && UIKit.UIDevice.CurrentDevice.UserInterfaceIdiom != UIUserInterfaceIdiom.Pad)
            {
                ...
                scratchpad.Frame = new CGRect(ResponsiveWidthRight, 500 + expandipad2, 100, 30);
            ...
            if (UIKit.UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Pad && View.Frame.Height >= 1194)
            {
                ...
                scratchpad.Frame = new CGRect(ResponsiveWidthRight, ButtonyourstoryscreenUpload.Frame.Bottom + 30, 100, 30);
                ButtonDelete1Line.Frame = new CGRect(ResponsiveWidthLeft, editTextWrite.Frame.Bottom + 30, 150, 30);
